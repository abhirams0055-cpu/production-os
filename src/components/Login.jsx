...
export default function Login() {
  ...
  const [mode, setMode] = useState(null); // null = home, 'team' = login form
      ...
      <div style={{ width:'100%', maxWidth:'520px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'16px' }}>
          ...
          >
            ...
            <div>
              <div style={{ fontFamily:'Syne', fontSize:'16px', fontWeight:'800', color:'#f0ede8', marginBottom:'6px' }}>Book a Shoot</div>
              <div style={{ fontSize:'12px', color:'rgba(240,237,232,0.5)', lineHeight:'1.5' }}>For clients and brands</div>
            </div>
            <div style={{ display:'flex', alignItems:'center', gap:'6px', color:'#c9a96e', fontSize:'12px', fontWeight:'600', fontFamily:'Syne' }}>
        ...
        <p style={{ textAlign:'center', color:'var(--text-dim)', fontSize:'11px', marginTop:'32px' }}>
  ...
  return (
    <div style={{
      minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center',
      background:'var(--bg)', padding:'20px',
      backgroundImage:'radial-gradient(ellipse at 20% 50%, rgba(8,63,62,0.3) 0%, transparent 60%)'
    }}>
      <div style={{ width:'100%', maxWidth:'400px' }}>
        ...
        <div className="card" style={{ padding:'28px', borderColor:'rgba(201,169,110,0.15)' }}>
          ...
          <div style={{ marginBottom:'16px' }}>
            ...
            <input className="input" type="email" placeholder="you@teamaaram.com"
          ...
          <button className="btn-primary" style={{ width:'100%', justifyContent:'center', padding:'12px', fontSize:'14px' }}
